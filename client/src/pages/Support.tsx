const Support = () => {
  return (
    <div className='pt-[80px] p-x-5 mx-auto max-w-7xl z-0 px-2 sm:px-6 lg:px-8 pb-8'>
        <h1 className='text-5xl py-3 font-bold text-[#04304d]'>Having problems? Reach us</h1>
        infos de contacto (se tiver login informações da escola e depois plataforma)

        <h1 className='text-3xl py-3 font-bold text-[#04304d]'>Frequently Asked Questions (F.A.Q)</h1>
