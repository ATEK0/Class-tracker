...
import { ClassTypeList, ClassroomList, TeacherListType, TextAlign } from '../../types';
...
const Table = (props: {
  ...
  useEffect(() => {
    async function loadClassroomList() {
      ...
      const classroomListResp = await httpClient.get(`${apiLink}/getClassroms`)
      ...
      setClassroomList(classroomListResp.data)
